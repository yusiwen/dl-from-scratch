...
class Linear:
    ...
    self-contained and doesn't depend on ml/mlp/model.py internals.
    """
...
def train():
    cfg = load_config("ml/basics/logistic_regression.yaml")
    set_seed(cfg["seed"])
    ...
    # Save weights.
    save_path = "ml/basics/logistic_regression.npz"
