...
from gen.ddpm.model import DDPM
from utils.config import load_config


def generate():
    cfg = load_config("gen/ddpm/config.yaml")
    ...
    Image.fromarray(grid_img).save("gen/ddpm/samples.png")
    print("Saved samples to gen/ddpm/samples.png")
