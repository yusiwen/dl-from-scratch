...
def train():
    ...
    writer.close()
    print("\nTraining complete!")
    torch.save(model, "cv/resnet18/resnet18_celeba.pt")
    save_config(cfg, "cv/resnet18/resnet18_celeba_config.yaml")
    print("Model saved to cv/resnet18/resnet18_celeba.pt")
