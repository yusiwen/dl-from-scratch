...
def generate():
    ...
    Image.fromarray(grid_img).save("vae/samples.png")
    print("Saved samples to vae/samples.png")
    ...
    grid_img = grid.mul(255).clamp(0, 255).permute(1, 2, 0).to(torch.uint8).numpy()
    Image.fromarray(grid_img).save("vae/interpolation.png")
    print("Saved interpolation to vae/interpolation.png")
